...
export class ValidatorsService {
  ...
  public isFieldOneEqualFieldTwo(field1: string, field2: string){
    return ( formGroup: AbstractControl):ValidationErrors | null => { //formGroup es la variable q amarra el formulario que llama a esta funcion
      const fielValue1 = formGroup.get(field1)?.value;
      const fielValue2 = formGroup.get(field2)?.value;

      console.log(fielValue1);
      console.log(fielValue2);
